...
void afficherImage2 ( int x,int y,SDL_Renderer* renderer,char* nomFichier ,uint8_t alpha )
{
    SDL_Surface* surface_image = SDL_LoadBMP (nomFichier);
    ...
    if ( surface_image ) {
        ...
        if (SDL_SetTextureAlphaMod(image,alpha) != 0){
            printf ("\nErreur changement alpha\n");
        }else{
            printf ("\nalpha : %d\n", alpha);
        }
...
void ActuEcranTitre (SDL_Renderer* renderer,int actu,uint8_t alpha)
{
    switch(actu) {
    case 0:
        afficherImage(0,0,renderer,"asset/ui/EcranTitre0.bmp");
        break;

    case 1:
        afficherImage2(0,0,renderer,"asset/ui/EcranTitre1.bmp",alpha);
        break;

    case 2:
        afficherImage(0,0,renderer,"asset/ui/EcranTitre1.bmp");
        break;

    case 3:
        afficherImage(0,0,renderer,"asset/ui/EcranTitre2.bmp");
        break;
...
{
    if (menuP == 1)afficherImage(0,0,renderer,"asset/ui/Pause1.bmp");
    if (menuP == 0)afficherImage(0,0,renderer,"asset/ui/Pause0.bmp");
}
...
void AfficherEtatInventaire (SDL_Renderer* renderer,int inv)
{
    switch(inv) {
    case 0 :
        afficherImage ( 980, 0, renderer, "asset/ui/IndicInv0.bmp");
        break;
    case 1 :
        afficherImage ( 980, 0, renderer, "asset/ui/IndicInv1.bmp");
        break;
    case 2 :
        afficherImage ( 980, 0, renderer, "asset/ui/IndicInv2.bmp");
        break;
    case 3 :
        afficherImage ( 980, 0, renderer, "asset/ui/IndicInv3.bmp");
        break;
    case 4 :
        afficherImage ( 980, 0, renderer, "asset/ui/IndicInv4.bmp");
        break;
    }
...
void AfficherPosition (int numLaby, SDL_Renderer* renderer)
{
    switch(numLaby) {
    case 0:
        afficherImage ( 1100, 0, renderer, "asset/ui/SignV.bmp");
        break;
    case 1:
        afficherImage ( 1100, 0, renderer, "asset/ui/SignB.bmp");
        break;
    case 2:
        afficherImage ( 1100, 0, renderer, "asset/ui/SignP.bmp");
        break;
    case 3:
        afficherImage ( 1100, 0, renderer, "asset/ui/SignC.bmp");
        break;
    }
}
...
void AfficherVieEnnemie (Perso Dummies[],int numLaby,SDL_Renderer* renderer)
{
    switch(numLaby) {
    case 1:
        afficherImage ( 60, 100, renderer, "asset/ui/VieMan.bmp");
        break;
    case 2:
        afficherImage ( 60, 100, renderer, "asset/ui/VieGar.bmp");
        break;
    case 3:
        afficherImage ( 60, 100, renderer, "asset/ui/VieMur.bmp");
        break;
    }
...
void AfficherRuby (int argent,SDL_Renderer* renderer,int etat)
{
    ...
    case 0:
        ...
        if (argent > 9 && argent < 20) {
            ...
            switch(temp) {
            case 0 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre0.bmp");
                break;
            case 1 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre1.bmp");
                break;
            case 2 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre2.bmp");
                break;
            case 3 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre3.bmp");
                break;
            case 4 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre4.bmp");
                break;
            case 5 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre5.bmp");
                break;
            case 6 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre6.bmp");
                break;
            case 7 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre7.bmp");
                break;
            case 8 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre8.bmp");
                break;
            case 9 :
                afficherImage ( 690+24, 40, renderer, "asset/ui/Chiffre9.bmp");
                break;
            }
        }
    ...
    for ( int y = 0 ; y < DIMY; y++ ) {
        for ( int x = 0 ; x < DIMX; x++ ) {
            ...
            case  '_' :
                ...
                switch(x) {
                case 6:
                    afficherImage ( x*60+75, y*60+190, renderer, "asset/map/Table1.bmp");
                    break;
                case 7:
                    afficherImage ( x*60+75, y*60+190, renderer, "asset/map/Table2.bmp");
                    break;
                case 8:
                    afficherImage ( x*60+75, y*60+190, renderer, "asset/map/Table3.bmp");
                    break;
                }
                break;
            case  'D' :
